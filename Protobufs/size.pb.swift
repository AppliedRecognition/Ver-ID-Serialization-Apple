...
extension Verid_Size: @unchecked Sendable {}
...
extension Verid_Size: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Verid_Size, rhs: Verid_Size) -> Bool {
